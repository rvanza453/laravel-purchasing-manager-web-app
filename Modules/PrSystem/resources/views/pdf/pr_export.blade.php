...
<head>
    ...
    <style>
        @page {
            margin: 4cm 3cm 3cm 3cm; /* Atas lebih besar agar halaman lanjutan tidak terlalu mepet */
        }
        ...
        * {
        ...
        body {
            ...
            line-height: 1.3;
            color: #000;
            padding: 20px; /* Kurangi padding internal agar tidak terlalu banyak */
        }
    ...
    <div class="info-section">
        ...
        <div class="info-right">
            <table class="info-table budget-info" style="width: auto; margin-left: auto;">
                <tr>
                    <td class="label">Total Anggaran (termasuk PTA)</td>
                    <td class="colon">:</td>
