    ...
    <div class="max-w-4xl mx-auto py-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
            ...
            <div class="border-t pt-6">
                ...
                <form action="{{ route('system.reset-warehouse.post') }}" method="POST" onsubmit="return confirm('Bersihkan cache Laravel sekarang? Tindakan ini aman untuk data, hanya menghapus cache, route, config, dan view cache.');">
                    @csrf
