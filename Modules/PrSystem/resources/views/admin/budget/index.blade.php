                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                             <p class="text-sm font-semibold text-gray-500">Total Budget</p>
                                <p class="text-xl font-bold text-indigo-600">Rp {{ number_format($department->budgets->sum(fn ($budget) => $budget->totalAmount()), 0, ',', '.') }}</p>
                        </div>
                    </div>
                            ...
                            @forelse($subDepartments as $sub)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-semibold text-indigo-600">
                                        Rp {{ number_format($sub->budgets->sum(fn ($budget) => $budget->totalAmount()), 0, ',', '.') }}
                                    </td>
