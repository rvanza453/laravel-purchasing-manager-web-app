<div class="overflow-x-auto rounded-lg border border-gray-200">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tfoot class="bg-gray-50">
            ...
            <tr>
                <th colspan="6" class="px-6 py-3 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Budget Dasar:</th>
                <th class="px-6 py-3 text-right text-sm font-bold text-gray-900">{{ number_format($budget->amount, 2) }}</th>
            </tr>
            <tr>
                <th colspan="6" class="px-6 py-3 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">PTA Tambahan:</th>
                <th class="px-6 py-3 text-right text-sm font-bold text-gray-900">{{ number_format($budget->pta_amount ?? 0, 2) }}</th>
            </tr>
            <tr>
                <th colspan="6" class="px-6 py-3 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Total Budget:</th>
                <th class="px-6 py-3 text-right text-sm font-bold text-gray-900">{{ number_format($budget->totalAmount(), 2) }}</th>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="6" class="px-6 py-3 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Remaining Budget:</th>
                <th class="px-6 py-3 text-right text-sm font-bold text-gray-900">{{ number_format($budget->remainingAmount(), 2) }}</th>
            </tr>
        </tfoot>
    </table>
</div>
