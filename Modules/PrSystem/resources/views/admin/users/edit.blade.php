    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-6">
                ...
                <!-- Username -->
                <div>
                    <x-prsystem::input-label for="username" :value="__('Username')" />
                    <x-prsystem::text-input id="username" name="username" type="text" class="mt-1 block w-full" :value="old('username', $user->username)" placeholder="contoh: muhammad_revanza" required />
                    <p class="text-xs text-gray-500 mt-1">Gunakan huruf, angka, garis bawah, atau tanda minus.</p>
                    <x-prsystem::input-error class="mt-2" :messages="$errors->get('username')" />
                </div>
