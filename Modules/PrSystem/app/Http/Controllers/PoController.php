...
class PoController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($isGlobal) {
            ...
            // Site-scoped Global Approver (e.g., Investor) only sees configured sites
            $query->whereHas('items.prItem.purchaseRequest.department', function ($d) use ($globalApproverSiteIds) {
    ...
    public function edit(PurchaseOrder $po)
    {
        ...
        return view('prsystem::po.edit', compact('po', 'vendors'));
    }
    ...
    public function update(Request $request, PurchaseOrder $po)
    {
        ...
        $po->update([
            'vendor_id' => $request->filled('vendor_id') ? $request->vendor_id : $po->vendor_id,
            'vendor_name' => $request->vendor_name,
            'vendor_address' => $request->vendor_address,
            'vendor_phone' => $request->vendor_phone,
            'vendor_postal_code' => $request->vendor_postal_code,
