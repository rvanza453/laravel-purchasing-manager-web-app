...
class PrItem extends Model
{
     ...
     * or the original quantity if no approval adjustment has been made yet
     */
    public function getFinalQuantity()
    {
        ...
        // If PR is missing, fall back to the original quantity
        if (!$pr) {
            return $this->quantity;
        }
        
        // Get all approved approvals with adjusted quantities for this item
