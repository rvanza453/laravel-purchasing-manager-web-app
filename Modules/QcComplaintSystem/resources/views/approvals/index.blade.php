                ...
                <div class="ap-card-body">
                    ...
                    <div class="ap-card-top">
                        ...
                        <div style="display:flex; gap:6px; flex-wrap:wrap; justify-content:flex-end;">
                            <span class="ap-deadline-badge {{ $finding->target_resolution_date ? 'set' : 'unset' }}">
                                {{ $finding->target_resolution_date ? 'Deadline Ada' : 'Deadline Belum Ada' }}
                            </span>
                    ...
                    <div class="ap-meta-row">
                        ...
                        <div class="ap-meta-item" style="grid-column: 1 / -1;">
                            ...
                            <div class="v">{{ optional($finding->target_resolution_date)->format('d M Y') ?? 'Belum ditentukan PIC' }}</div>
                        </div>
                    </div>
