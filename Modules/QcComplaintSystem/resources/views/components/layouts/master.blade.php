...
<aside class="sidebar">
    ...
    <nav class="nav">
        ...
        @endif
        @if(in_array($qcRole, ['QC Admin', 'QC Officer', 'QC Approver']))
            <a href="{{ route('qc.deadlines.index') }}" class="{{ request()->routeIs('qc.deadlines.*') ? 'active' : '' }}"><i class="fas fa-calendar-day"></i> INBOX PIC</a>
        @endif
        @if($canCreateFinding)
        ...
        @endif
        @if($qcRole === 'QC Admin')
            <a href="{{ route('qc.approval-config.index') }}" class="{{ request()->routeIs('qc.approval-config.*') ? 'active' : '' }}"><i class="fas fa-sliders"></i> Approval Config</a>
        @endif
    </nav>
...
<nav class="mobile-bottom-nav" aria-label="QC mobile navigation">
    <div class="mobile-bottom-nav-inner">
        ...
        <a href="{{ route('qc.deadlines.index') }}" class="{{ request()->routeIs('qc.deadlines.*') ? 'active' : '' }}"><i class="fas fa-calendar-day"></i><span>INBOX PIC</span></a>
