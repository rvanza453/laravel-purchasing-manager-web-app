...
class PoController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $vendors = \App\Models\Vendor::where('status', '!=', 'Di Ajukan')->orderBy('name')->get();

        return view('po.create', compact('selectedItems', 'prNumberString', 'prDateString', 'firstPr', 'vendors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        \App\Helpers\ActivityLogger::log('created', 'Created Purchase Order: ' . $po->po_number, $po);
    ...
    public function update(Request $request, PurchaseOrder $po)
    {
        ...
        \App\Helpers\ActivityLogger::log('updated', 'Updated Purchase Order: ' . $po->po_number . ' (Status: ' . $po->status . ')', $po);
    ...
    public function destroy(PurchaseOrder $po)
    {
        ...
        \App\Helpers\ActivityLogger::log('deleted', 'Deleted Purchase Order: ' . $po_number);
