...
class ProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.products.index', compact('products', 'sites'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('sites','categories'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('admin.products.edit', compact('product', 'sites','categories'));
    }
    ...
    public function destroy(Request $request, Product $product)
    {
        ...
        $name = $product->name;
        $product->delete();
        \App\Helpers\ActivityLogger::log('deleted', 'Deleted Product: ' . $name);
