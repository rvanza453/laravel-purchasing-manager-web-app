    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            if (empty($model->capex_number)) {
                // Format: CPX/SITE/ROMAN/YEAR/XXXX
                ...
                $sequence = $latest ? intval(substr($latest->capex_number, -4)) + 1 : 1;
                
                $model->capex_number = sprintf("CPX/%s/%s/%s/%04d", $siteName, $roman, $year, $sequence);
            }
        });
    }
