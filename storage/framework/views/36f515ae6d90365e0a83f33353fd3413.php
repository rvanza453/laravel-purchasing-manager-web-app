    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    <h2 class="text-3xl font-bold text-gray-800"><?php echo e($warehouse->name); ?></h2>
                    <span class="px-2.5 py-0.5 rounded-full text-xs font-bold bg-blue-100 text-blue-800 border border-blue-200">
                        <?php echo e($warehouse->site->name ?? 'No Site'); ?>
            ...
            <div class="flex flex-col items-end gap-2">
                 <a href="<?php echo e(route('inventory.index')); ?>" class="text-sm font-medium text-gray-500 hover:text-gray-700 flex items-center gap-1 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stocks->total()); ?></p>
                </div>
            </div>
            ...
            <div class="md:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <a href="<?php echo e(route('inventory.movement', ['warehouse' => $warehouse, 'type' => 'IN'])); ?>" 
                    ...
                    <a href="<?php echo e(route('inventory.movement', ['warehouse' => $warehouse, 'type' => 'OUT'])); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <!-- Search Form -->
                    <form method="GET" action="<?php echo e(route('inventory.show', $warehouse)); ?>" class="flex gap-2">
                        <div class="relative">
                            <input type="text" 
                                   name="search" 
                        ...
                        <?php if(request('search')): ?>
                            <a href="<?php echo e(route('inventory.show', $warehouse)); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-medium text-sm">
                                Clear
                            </a>
                        <?php endif; ?>
                    </form>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <?php echo e($stock->product->code); ?>

                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    <div class="font-medium text-gray-900"><?php echo e($stock->product->name); ?></div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="text-sm font-bold <?php echo e($stock->quantity > $stock->product->min_stock ? 'text-green-600' : 'text-red-600'); ?>">
                                        <?php echo e($stock->formatted_quantity); ?>

                                    </span>
                                    <span class="text-xs text-gray-500 ml-1"><?php echo e($stock->product->unit); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <a href="<?php echo e(route('inventory.history', ['warehouse' => $warehouse, 'product_id' => $stock->product_id])); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                ...
                <a href="<?php echo e(route('inventory.history', $warehouse)); ?>" class="text-sm font-bold text-primary-600 hover:text-primary-800 flex items-center gap-1 hover:underline">
                    Lihat Semua
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <div class="font-bold"><?php echo e($movement->product->name); ?></div>
                                    <div class="text-xs text-gray-500 mt-0.5"><?php echo e($movement->product->code); ?></div>
                                </td>
...
<?php endif; ?>
<?php /**PATH C:\Users\deniz\Downloads\plantation.oilpam.my.id (1)\plantation.oilpam.my.id\Modules/PrSystem\resources/views/inventory/show.blade.php ENDPATH**/ ?>