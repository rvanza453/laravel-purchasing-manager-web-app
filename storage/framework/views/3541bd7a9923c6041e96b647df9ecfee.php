...
<?php $component = Modules\ServiceAgreementSystem\View\Components\Layouts\Master::resolve(['title' => 'Login - ERP Plantation Saraswanti'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="login-page">
        <div class="login-container">
            ...
            <div class="login-card">
                ...
                <form action="<?php echo e(route('sas.login.submit')); ?>" method="POST" id="loginForm">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" id="emailField" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="user@sas.test" required autofocus>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\deniz\Downloads\plantation.oilpam.my.id (1)\plantation.oilpam.my.id\Modules/ServiceAgreementSystem\resources/views/auth/login.blade.php ENDPATH**/ ?>