...
<div class="shell">
    <div class="head">
        ...
        <div class="actions">
            <a href="<?php echo e(route('modules.index')); ?>" class="btn">Kembali ke Module Hub</a>
    ...
    <div class="grid">
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($item['route']); ?>" class="card">
                <div class="icon"><i class="fas <?php echo e($item['icon']); ?>"></i></div>
...
<?php /**PATH C:\laragon\www\plantation.oilpam.my.id\resources\views/management/index.blade.php ENDPATH**/ ?>