...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'qccomplaintsystem::components.layouts.master','data' => ['title' => 'Daftar Aduan Kebun QC']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Daftar Aduan Kebun QC')]); ?>
    <style>
        .finding-list-shell {
            display:grid;
            gap:14px;
    ...
    <div class="finding-list-shell">
        <div class="finding-headline">
            ...
            <div style="display:flex; gap:8px; flex-wrap:wrap;">
                <a href="<?php echo e(route('qc.dashboard')); ?>" class="btn"><i class="fas fa-chart-pie"></i> Dashboard Summary</a>
                <?php if($canCreateFinding): ?>
                    <a href="<?php echo e(route('qc.findings.create')); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Lapor Temuan Baru</a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="dashboard-grid">
            <div class="dashboard-left">
                <div class="summary-strip">
                    <div class="summary-box"><div class="k">Open</div><div class="v"><?php echo e($countOpen); ?></div></div>
                    <div class="summary-box"><div class="k">In Review</div><div class="v"><?php echo e($countReview); ?></div></div>
                    <div class="summary-box"><div class="k">Perlu Submit Ulang</div><div class="v" style="color:#b91c1c;"><?php echo e($countResub); ?></div></div>
                    <div class="summary-box"><div class="k">Urgensi Tinggi</div><div class="v" style="color:#92400e;"><?php echo e($countHigh); ?></div></div>
                </div>

                <div class="finding-filter">
                    <form method="GET" action="<?php echo e(route('qc.findings.index')); ?>" class="finding-filter-grid">
                        <div class="field">
                            <label>Site</label>
                            <select name="site_id" id="site_id" class="select" <?php if(!$isHoUser): echo 'disabled'; endif; ?>>
                                <option value="">Semua Site</option>
                                <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($site->id); ?>" <?php if((string)($filters['site_id'] ?? '') === (string)$site->id): echo 'selected'; endif; ?>><?php echo e($site->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php if(!$isHoUser): ?>
                                <input type="hidden" name="site_id" value="<?php echo e($filters['site_id']); ?>">
                            <?php endif; ?>
                        </div>
                        <div class="field">
                            ...
                            <select name="department_id" id="department_id" class="select">
                                ...
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($department->id); ?>" <?php if((string)($filters['department_id'] ?? '') === (string)$department->id): echo 'selected'; endif; ?>><?php echo e($department->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="sub_department_id" id="sub_department_id" class="select">
                                ...
                                <?php $__currentLoopData = $subDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subDepartment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subDepartment->id); ?>" <?php if((string)($filters['sub_department_id'] ?? '') === (string)$subDepartment->id): echo 'selected'; endif; ?>><?php echo e($subDepartment->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="status" class="select">
                                ...
                                <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status); ?>" <?php if(($filters['status'] ?? null) === $status): echo 'selected'; endif; ?>><?php echo e($status === 'in_review' ? 'IN REVIEW' : strtoupper($status)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="urgency" class="select">
                                ...
                                <?php $__currentLoopData = $urgencyOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $urgency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($urgency); ?>" <?php if(($filters['urgency'] ?? null) === $urgency): echo 'selected'; endif; ?>><?php echo e(\Modules\QcComplaintSystem\Models\QcFinding::urgencyLabel($urgency)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="field">
                            <label>Tanggal Dari</label>
                            <input type="date" name="date_from" class="input" value="<?php echo e($filters['date_from'] ?? ''); ?>">
                        </div>
                        <div class="field">
                            <label>Tanggal Sampai</label>
                            <input type="date" name="date_to" class="input" value="<?php echo e($filters['date_to'] ?? ''); ?>">
                        </div>
                        <div class="field">
                            <label>Kategori</label>
                            <select name="kategori" id="kategori" class="select">
                                <option value="">Semua Kategori</option>
                                <?php $__currentLoopData = \Modules\QcComplaintSystem\Models\QcFinding::categoryHierarchy(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php if(($filters['kategori'] ?? null) === $key): echo 'selected'; endif; ?>><?php echo e($cat['label']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="field">
                        ...
                        <div class="field" style="grid-column: span 2;">
                            ...
                            <input type="text" class="input" name="keyword" value="<?php echo e($filters['keyword'] ?? ''); ?>" placeholder="Cari nomor/judul/lokasi/pelapor">
                        </div>
                        <div class="field" style="display:flex; justify-content:flex-end; align-items:flex-end;">
                            <label style="display:flex; align-items:center; gap:8px; font-size:12px; font-weight:700; color:#475569; margin:0;">
                                <input type="checkbox" name="needs_resubmission" value="1" <?php if(($filters['needs_resubmission'] ?? null) == 1): echo 'checked'; endif; ?>>
                                Hanya yang Perlu Submit Ulang
                            </label>
                        </div>
                        <div class="field" style="display:flex; justify-content:flex-end; align-items:flex-end; gap:4px;">
                            <a href="<?php echo e(route('qc.findings.index')); ?>" class="btn">Reset</a>
                        </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $findings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $finding): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            ...
                            $submittedAt = $finding->created_at;
                            $closedAt = $finding->closed_at;
                            $closedLeadTimeDays = ($finding->status === 'closed' && $submittedAt && $closedAt)
                                ? $submittedAt->diffInDays($closedAt)
                                : null;
                        ?>
                        <tr class="<?php echo e($rowClass); ?>">
                            <td>
                                <div class="row-title"><?php echo e($finding->finding_number); ?> - <?php echo e($finding->title); ?></div>
                                <div class="row-sub"><?php echo e($finding->location ?: 'Tanpa detail lokasi tambahan'); ?></div>
                                <?php if($finding->kategori): ?>
                                    <span style="display:inline-block;margin-top:4px;border-radius:999px;background:#e0f2fe;color:#0369a1;font-size:11px;font-weight:700;padding:2px 8px;">
                                        ...
                                        ?>
                                        <?php echo e($catLabel); ?><?php echo e($subLabel); ?><?php echo e($codeLabel); ?>

                                    </span>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e(optional($finding->finding_date)->format('d M Y') ?? '-'); ?></td>
                            <td>
                                <div class="row-sub"><?php echo e($finding->department?->site?->name ?? '-'); ?></div>
                                <div><?php echo e($finding->department?->name ?? '-'); ?> / <?php echo e($finding->subDepartment?->name ?? '-'); ?> / <?php echo e($finding->block?->name ?? '-'); ?></div>
                            </td>
                            <td>
                                <div class="row-sub">Pelapor</div>
                                <div><?php echo e($finding->reporter?->name ?? $finding->reporter_name ?? '-'); ?></div>
                                <div class="row-sub" style="margin-top:4px;">PIC: <?php echo e($picNames->isNotEmpty() ? $picNames->join(', ') : '-'); ?></div>
                            </td>
                            <td>
                                <div style="display:flex; gap:6px; flex-wrap:wrap; margin-bottom:6px;">
                                    <span class="badge badge-<?php echo e($finding->status); ?>"><?php echo e($statusLabel); ?></span>
                                    <span class="badge badge-<?php echo e($finding->urgency); ?>"><?php echo e(\Modules\QcComplaintSystem\Models\QcFinding::urgencyLabel($finding->urgency)); ?></span>
                                </div>
                                <?php if($finding->needs_resubmission): ?>
                                    <span class="flag-chip flag-revision">Perlu Submit Ulang</span>
                                <?php elseif($isHighPriority): ?>
                                    <span class="flag-chip flag-high">Perlu Atensi Cepat</span>
                                <?php endif; ?>
                                <div class="row-sub" style="margin-top:6px;">Progress approval: <?php echo e($approvalProgress); ?></div>
                                <?php if($finding->status === 'closed' && !is_null($closedLeadTimeDays)): ?>
                                    <div class="row-sub" style="margin-top:4px; color:#0f766e; font-weight:700;">
                                        Lead time closed: <?php echo e($closedLeadTimeDays === 0 ? '< 1 hari' : $closedLeadTimeDays . ' hari'); ?>

                                    </div>
                                <?php endif; ?>
                            </td>
                            <td>
                                <a href="<?php echo e(route('qc.findings.show', $finding)); ?>" class="btn btn-primary btn-sm">Buka Detail</a>
                            </td>
                        </tr>
    ...
    <script>
        (function () {
            ...
            const categoryHierarchy = <?php echo json_encode(\Modules\QcComplaintSystem\Models\QcFinding::categoryHierarchy(), 15, 512) ?>;
            const selectedSubKategori = <?php echo json_encode($filters['sub_kategori'] ?? '', 15, 512) ?>;
            ...
            function loadSubDepartments(departmentId) {
                ...
                fetch(`<?php echo e(url('qc/api/sub-departments')); ?>/${departmentId}`)
            ...
            const counts = <?php echo json_encode($statusCounts, 15, 512) ?>;
            ...
            const categoryBreakdown = <?php echo json_encode($categoryBreakdown, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\Users\deniz\Downloads\plantation.oilpam.my.id (1)\plantation.oilpam.my.id\Modules/QcComplaintSystem\resources/views/findings/index.blade.php ENDPATH**/ ?>