<?php if(auth()->check() && Route::has('modules.index') && !request()->routeIs('modules.index')): ?>
    <style>
        .module-hub-fab {
            position: fixed;
            top: 50%;
...
<?php endif; ?>
<?php /**PATH C:\Users\deniz\Downloads\plantation.oilpam.my.id (1)\plantation.oilpam.my.id\resources\views/components/module-hub-button.blade.php ENDPATH**/ ?>