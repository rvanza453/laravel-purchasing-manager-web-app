    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex justify-between items-start">
            <div>
                ...
                <div class="text-sm text-gray-500">Nomor: <?php echo e($pr->pr_number); ?></div>
            </div>
            <div class="flex items-center gap-3">
                ...
                <?php if($isApproved): ?>
                    <a href="<?php echo e(route('pr.export.pdf', $pr)); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 space-y-4">
            <?php if(isset($budgetWarnings) && count($budgetWarnings) > 0): ?>
                <div class="mb-4 bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg">
                    ...
                    <ul class="list-disc list-inside text-sm mt-1">
                        <?php $__currentLoopData = $budgetWarnings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warning): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <span class="block text-sm font-medium text-gray-800"><?php echo e($pr->user->name); ?></span>
                </div>
                <div>
                    <span class="block text-xs text-gray-400 uppercase">Tanggal</span>
                    <span class="block text-sm font-medium text-gray-800"><?php echo e($pr->request_date->format('d M Y')); ?></span>
                </div>
                <div>
                    ...
                    <span class="block text-sm font-medium text-gray-800">
                        ...
                        <?php if($pr->subDepartment): ?>
                             / <?php echo e($pr->subDepartment->name); ?>
                        ...
                        <?php if($isJob && $job): ?>
                             / <?php echo e($job->code ?? ''); ?><?php echo e($job->code ? '-' : ''); ?><?php echo e($job->name); ?>

                        <?php elseif($isStation && $pr->subDepartment && $pr->subDepartment->coa): ?>
                             / <?php echo e($pr->subDepartment->coa); ?>
                ...
                <div>
                    ...
                    <span class="block text-sm font-medium text-gray-800">Rp <?php echo e(number_format($pr->total_estimated_cost, 0, ',', '.')); ?></span>
                </div>
                <div>
                    <span class="block text-xs text-gray-400 uppercase">Lampiran File</span>
                    <?php if($pr->attachment_path): ?>
                         <div class="flex items-center gap-2 mt-1">
                                      <a href="<?php echo e(route('pr.attachment.view', $pr)); ?>" target="_blank" class="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                View
                             </a>
                             <a href="<?php echo e(route('pr.attachment.download', $pr)); ?>" class="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-green-600 bg-green-50 hover:bg-green-100 border border-green-200 rounded-lg transition-colors">
            ...
            <div class="pt-4 border-t border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                     ...
                     <p class="text-sm text-gray-600"><?php echo e($pr->description); ?></p>
                </div>
                
                <?php if(isset($budgetInfo)): ?>
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <table class="w-full text-sm">
                        <tr>
                            <td class="text-gray-600 py-1">Total Anggaran (termasuk PTA)</td>
                            <td class="text-gray-400 px-2">:</td>
                            <td class="font-medium text-gray-900 text-right">Rp <?php echo e(number_format($budgetInfo['total'], 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td class="text-gray-600 py-1">Actual Pengeluaran</td>
                            <td class="text-gray-400 px-2">:</td>
                            <td class="font-medium text-gray-900 text-right">Rp <?php echo e(number_format($budgetInfo['actual'], 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td class="text-gray-600 py-1">Permintaan Saat Ini</td>
                            <td class="text-gray-400 px-2">:</td>
                            <td class="font-medium text-gray-900 text-right">Rp <?php echo e(number_format($budgetInfo['current'], 0, ',', '.')); ?></td>
                        </tr>
                        <tr class="border-t border-gray-200">
                            <td class="text-gray-800 font-bold py-2">Saldo Anggaran</td>
                            <td class="text-gray-400 px-2">:</td>
                            <td class="font-bold <?php echo e($budgetInfo['saldo'] < 0 ? 'text-red-600' : 'text-green-600'); ?> text-right">Rp <?php echo e(number_format($budgetInfo['saldo'], 0, ',', '.')); ?></td>
                        </tr>
                    </table>
                </div>
                <?php endif; ?>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                Approver: <span class="font-semibold"><?php echo e($holdApproval->approver->name); ?></span> 
                                <span class="text-gray-400">• <?php echo e($holdApproval->approved_at?->format('d M Y H:i') ?? '-'); ?></span>
                            </p>
                            ...
                            <div class="mt-4 bg-white rounded-lg p-4 border border-orange-200">
                                ...
                                <p class="text-sm text-gray-800"><?php echo e($holdApproval->remarks); ?></p>
                            </div>

                            <?php if(auth()->id() == $pr->user_id): ?>
                                <?php if($holdApproval->hold_reply): ?>
                                    ...
                                    <div class="mt-4 bg-blue-50 rounded-lg p-4 border border-blue-200">
                                        <div class="flex items-center gap-2 mb-2">
                                            ...
                                            <span class="text-xs text-blue-500"><?php echo e($holdApproval->replied_at->format('d M Y H:i')); ?></span>
                                        </div>
                                        <p class="text-sm text-gray-800"><?php echo e($holdApproval->hold_reply); ?></p>
                                ...
                                <?php else: ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('pr.replyHold', $pr)); ?>" class="mt-4">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                ...
                <?php if($isApproved): ?>
                    <?php if($isExpired): ?>
                        <?php
                            $expiredClass = $pr->po_status === 'Partial PO' 
                                ? 'bg-gray-100 text-gray-600 border-gray-200' 
                                : 'bg-red-100 text-red-700 border-red-200';
                        ?>
                        <div class="px-3 py-1 <?php echo e($expiredClass); ?> rounded-lg text-sm font-bold border flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                            <?php if($pr->po_status === 'Partial PO'): ?>
                                KADALUARSA PARSIAL (Partial Expired)
                            <?php else: ?>
                                KADALUARSA (Expired)
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
                        <div class="flex gap-2">
                            ...
                            <button type="submit" 
                                    form="po-form"
                                    formaction="<?php echo e(route('po.create')); ?>"
                                    id="generate-po-btn" 
                                    disabled
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <!-- Status Not Approved: <?php echo e($pr->status); ?> -->
                <?php endif; ?>
            </div>
            
            <?php if($isApproved): ?>
                <form id="po-form" method="POST" action="<?php echo e(route('po.create')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="pr_id" value="<?php echo e($pr->id); ?>">
            <?php endif; ?>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $pr->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr class="<?php echo e($hasPo ? 'bg-gray-50' : ''); ?>">
                            <?php if($isApproved): ?>
                                <td class="px-6 py-4 text-sm">
                                    <?php if(!$hasPo): ?>
                                        <input type="checkbox" name="selected_items[]" value="<?php echo e($item->id); ?>" class="item-checkbox rounded border-gray-300 text-primary-600 focus:ring-primary-500" onchange="updateGenerateButton()">
                                    <?php else: ?>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900">
                                ...
                                <?php if($item->specification): ?>
                                    <div class="text-xs text-gray-500 mt-0.5"><?php echo e($item->specification); ?></div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-500">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900 font-semibold">
                                <?php echo e(number_format($item->current_stock ?? 0, 0, ',', '.')); ?> <?php echo e($item->unit); ?>
                            ...
                            <?php if($canApprove): ?>
                                <td class="px-6 py-4 text-sm text-gray-900 bg-blue-50">
                                    ...
                                    ?>
                                    <input type="number" 
                                           name="adjusted_quantities[<?php echo e($item->id); ?>]" 
                                           class="w-24 border-blue-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" 
                                           min="0" 
                                           step="1"
                                           value="<?php echo e(old('adjusted_quantities.' . $item->id)); ?>"
                                           placeholder="<?php echo e($finalQty); ?>">
                                </td>
                            <?php else: ?>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <?php
                                    ...
                                    <?php if($hasAdjustment): ?>
                                        <div class="flex items-center gap-2">
                                            <span class="text-xs text-gray-400 line-through"><?php echo e($item->quantity); ?></span>
                                            <span class="font-bold text-blue-600"><?php echo e($finalQty); ?></span>
                                        </div>
                                    <?php else: ?>
                                        <span class="text-gray-900"><?php echo e($finalQty); ?></span>
                                    <?php endif; ?>
                                </td>
                            <?php endif; ?>

                            <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($item->unit); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-900 text-right">Rp <?php echo e(number_format($item->price_estimation, 0, ',', '.')); ?></td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 text-right">
                                ...
                                ?>
                                Rp <?php echo e(number_format($displayTotal, 0, ',', '.')); ?>

                            </td>
                            <td class="px-6 py-4 text-sm">
                                <?php if($item->url_link): ?>
                                    <a href="<?php echo e($item->url_link); ?>" target="_blank" class="inline-flex items-center gap-1 text-xs font-medium text-blue-600 hover:text-blue-800 bg-blue-50 px-2 py-1 rounded border border-blue-200 hover:bg-blue-100 transition-colors" title="Buka Link Referensi">
                            ...
                            <?php if($pr->status === 'Approved'): ?>
                                <td class="px-6 py-4 text-sm">
                                    <?php if($hasPo && $firstPo): ?>
                                        <a href="<?php echo e(route('po.show', $firstPo)); ?>" class="inline-flex items-center gap-1 text-xs font-medium text-green-600 hover:text-green-800 bg-green-50 px-2 py-1 rounded border border-green-200 hover:bg-green-100 transition-colors">
                                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
                                            <?php echo e($firstPo->po_number); ?>
                ...
                <script>
                    ...
                    async function addToCart() {
                        ...
                        try {
                            ...
                            const res = await fetch('<?php echo e(route("po.cart.add")); ?>', {
                                method: 'POST',
                                headers: {
        ...
        <?php if($canApprove): ?>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 space-y-4 mt-6">
                ...
                <div class="flex justify-end gap-3 pt-2">
                     ...
                     <?php endif; ?>
                     <button type="submit" 
                             formaction="<?php echo e(route('approval.reject', $currentApproval->id)); ?>"
                     ...
                     <button type="submit" 
                             formaction="<?php echo e(route('approval.hold', $currentApproval->id)); ?>"
                     ...
                     <button type="submit" 
                             formaction="<?php echo e(route('approval.approve', $currentApproval->id)); ?>"
        ...
        <?php if($isPrAdmin): ?>
            <form id="full-approve-form" action="<?php echo e(route('pr.full-approve', $pr)); ?>" method="POST" class="hidden">
                <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="relative pl-6 border-l-2 border-gray-200 space-y-8">
                <?php $__currentLoopData = $pr->approvals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative">
                        <!-- Dot -->
                        <div class="absolute -left-[31px] bg-white border-2 <?php echo e($approval->status === 'Approved' ? 'border-green-500' : ($approval->status === 'Rejected' ? 'border-red-500' : ($approval->status === 'On Hold' ? 'border-orange-500' : 'border-gray-300'))); ?> w-4 h-4 rounded-full"></div>
                        
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <span class="text-sm font-bold text-gray-900"><?php echo e($approval->role_name); ?> (<?php echo e($approval->approver->name); ?>)</span>
                                <span class="block text-xs text-gray-400">Level <?php echo e($approval->level); ?></span>
                            </div>
                            <div class="mt-1 sm:mt-0 flex items-center gap-3">
                                <?php if($approval->status === 'Approved'): ?>
                                    <div class="text-right">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Approved</span>
                                        <span class="block text-xs text-gray-400 text-right"><?php echo e($approval->approved_at ? $approval->approved_at->format('d M H:i') : ''); ?></span>
                                    </div>
                                ...
                                <?php elseif($approval->status === 'On Hold'): ?>
                                    <div class="text-right">
                                ...
                                <?php if($isPrAdmin): ?>
                                    <?php if($approval->id === $latestProcessedId): ?>
                                        <form method="POST" action="<?php echo e(route('approval.revert', $approval->id)); ?>" class="inline ml-2" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan (Undo) proses approval ini? Status PR akan kembali ke posisi sebelumnya.')">
                                            <?php echo csrf_field(); ?>
                        ...
                        <?php if($approval->remarks): ?>
                            <div class="mt-2 text-sm text-orange-700 bg-orange-50 p-2 rounded border border-orange-100">
                                ...
                                "<i><?php echo e($approval->remarks); ?></i>"
                            </div>
                        <?php endif; ?>
                        <?php if($approval->hold_reply): ?>
                            <div class="mt-1 text-sm text-blue-700 bg-blue-50 p-2 rounded border border-blue-100 flex items-start gap-2">
                                ...
                                <span><i><?php echo e($approval->hold_reply); ?></i>
                                    <?php if($approval->replied_at): ?>
                                        <span class="text-xs text-blue-400 ml-1">· <?php echo e($approval->replied_at->format('d M H:i')); ?></span>
                                    <?php endif; ?>
                                </span>
                            </div>
                        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\deniz\Downloads\plantation.oilpam.my.id (1)\plantation.oilpam.my.id\Modules/PrSystem\resources/views/pr/show.blade.php ENDPATH**/ ?>