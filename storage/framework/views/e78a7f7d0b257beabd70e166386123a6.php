...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> - Service Agreement System</title>
...
<body>
    ...
    <aside class="sidebar" id="sasSidebar">
        ...
        <nav class="sidebar-nav">
            <div class="sidebar-section">
                ...
                <a href="<?php echo e(route('sas.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('sas.dashboard') ? 'active' : ''); ?>">
            ...
            <div class="sidebar-section">
                ...
                <a href="<?php echo e(route('sas.contractors.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('sas.contractors.*') ? 'active' : ''); ?>">
                    <i class="fas fa-hard-hat"></i> Kontraktor
                </a>
                <a href="<?php echo e(route('sas.approval-schemas.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('sas.approval-schemas.*') ? 'active' : ''); ?>">
            ...
            <div class="sidebar-section">
                ...
                <a href="<?php echo e(route('sas.uspk.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('sas.uspk.*') && !request()->routeIs('sas.uspk-approvals.*') ? 'active' : ''); ?>">
                    <i class="fas fa-file-signature"></i> Pengajuan USPK
                </a>
                <a href="<?php echo e(route('sas.uspk-budgets.index')); ?>" class="sidebar-link menu-uspk-budget <?php echo e(request()->routeIs('sas.uspk-budgets.*') ? 'active' : ''); ?>" data-menu="uspk-budget">
        ...
        <div class="sidebar-user">
            <div class="sidebar-user-info">
                ...
                <div>
                    <div class="sidebar-user-name"><?php echo e(auth()->user()->name ?? 'User'); ?></div>
                    <div class="sidebar-user-role"><?php echo e(auth()->user()->position ?? 'Staff'); ?></div>
                </div>
                <form action="<?php echo e(route('sas.logout')); ?>" method="POST" style="margin-left: auto;">
                    <?php echo csrf_field(); ?>
    ...
    <main class="main-content">
        <div class="mobile-header">
            ...
            <div class="mobile-header-title"><?php echo e($title ?? 'Dashboard'); ?></div>
            <a href="<?php echo e(route('modules.index')); ?>" class="mobile-menu-btn" aria-label="Kembali ke Hub Modul">
                <i class="fas fa-arrow-left"></i>
            </a>
        </div>

        <div class="top-bar">
            <div class="top-bar-title"><?php echo e($title ?? 'Dashboard'); ?></div>
    ...
    <nav class="mobile-bottom-nav" aria-label="SAS mobile navigation">
        <div class="mobile-bottom-nav-inner">
            ...
            <a href="<?php echo e(route('sas.dashboard')); ?>" class="<?php echo e(request()->routeIs('sas.dashboard') ? 'active' : ''); ?>"><i class="fas fa-chart-pie"></i><span>Dashboard</span></a>
            <a href="<?php echo e(route('sas.uspk.index')); ?>" class="<?php echo e(request()->routeIs('sas.uspk.*') ? 'active' : ''); ?>"><i class="fas fa-file-signature"></i><span>USPK</span></a>
            <a href="<?php echo e(route('sas.uspk-budgets.index')); ?>" class="<?php echo e(request()->routeIs('sas.uspk-budgets.*') ? 'active' : ''); ?>"><i class="fas fa-wallet"></i><span>Budget</span></a>
...
<?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/ServiceAgreementSystem\resources/views/components/layouts/master.blade.php ENDPATH**/ ?>