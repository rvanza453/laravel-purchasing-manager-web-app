...
<head>
    ...
    <title><?php echo e(config('app.name', 'System Support')); ?> | IT Helpdesk</title>
...
<body class="antialiased min-h-screen flex flex-col relative overflow-x-hidden pt-6">
    ...
    <header class="glass-panel mx-6 p-4 flex justify-between items-center z-10 sticky top-6 shadow-xl shadow-black/50">
        <div class="flex items-center gap-4">
            ...
            <div>
                <a href="<?php echo e(route('systemsupport.dashboard')); ?>">
        ...
        <nav class="flex gap-2 items-center">
            ...
            <div class="hidden md:flex gap-4 mr-4 text-sm font-medium text-gray-400">
                <a href="<?php echo e(route('systemsupport.tickets.index')); ?>" class="hover:text-white transition <?php echo e(request()->routeIs('systemsupport.tickets.*') ? 'text-white border-b-2 border-blue-500' : ''); ?>">Tickets</a>
                <?php if(Auth::user()->hasAnyRole(['Admin', 'Admin IT', 'Helpdesk'])): ?>
                <a href="<?php echo e(route('systemsupport.announcements.index')); ?>" class="hover:text-white transition <?php echo e(request()->routeIs('systemsupport.announcements.*') ? 'text-white border-b-2 border-blue-500' : ''); ?>">Announcements</a>
                <?php endif; ?>
                <!-- Future module links -->
                <a href="#" class="hover:text-white transition opacity-50 cursor-not-allowed">Changelog</a>
            </div>
            <a href="<?php echo e(route('modules.index')); ?>" class="px-4 py-2 rounded-lg text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-800 transition">
...
</html><?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/SystemSupport\resources/views/components/layouts/master.blade.php ENDPATH**/ ?>