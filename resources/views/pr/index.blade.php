<x-app-layout>
    <div class="space-y-6">
        ...
        <!-- Filters -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden" x-data="{ filterOpen: {{ request()->hasAny(['search', 'status', 'department_id', 'sub_department_id', 'current_approver_id', 'start_date', 'end_date']) ? 'true' : 'false' }} }">
            <!-- Filter Header -->
            <div class="px-5 py-3 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100 flex items-center justify-between cursor-pointer" @click="filterOpen = !filterOpen">
                <div class="flex items-center gap-3">
                    ...
                    @if(request()->hasAny(['search', 'status', 'department_id', 'sub_department_id', 'current_approver_id', 'start_date', 'end_date']))
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-3 items-end">
                            ...
                            <div class="md:col-span-2 flex gap-2">
                                ...
                                <a href="{{ route('pr.index', ['view_mode' => $viewMode ?? 'pr']) }}" class="flex-1 px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 text-center shadow-sm transition-colors duration-150 flex items-center justify-center gap-2">
