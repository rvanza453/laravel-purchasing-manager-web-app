<x-app-layout>
    <div class="space-y-6">
        ...
        <!-- Filters -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden" x-data="{ filterOpen: {{ request()->hasAny(['search', 'status', 'department_id', 'sub_department_id', 'current_approver_id', 'start_date', 'end_date']) || session()->has('pr_filters') ? 'true' : 'false' }} }">
            <!-- Filter Header -->
            <div class="px-5 py-3 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100 flex items-center justify-between cursor-pointer" @click="filterOpen = !filterOpen">
                <div class="flex items-center gap-3">
                    ...
                    @if(request()->hasAny(['search', 'status', 'department_id', 'sub_department_id', 'current_approver_id', 'start_date', 'end_date']) || session()->has('pr_filters'))
