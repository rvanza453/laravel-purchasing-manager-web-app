...
<div class="card-body" style="display:grid; gap:16px;">
    ...
    <div class="field">
        ...
        <input type="text" name="username" class="input" value="{{ old('username', $user->username) }}" placeholder="contoh: muhammad_revanza" required>
        <small style="color:#64748b;">Gunakan huruf, angka, garis bawah, atau tanda minus.</small>
    </div>
