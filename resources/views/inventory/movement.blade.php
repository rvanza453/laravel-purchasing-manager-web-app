<x-app-layout>
    ...
    <script>
        ...
        function handleSubDeptChange(select, index) {
            ...
            // \App\Enums\BudgetingType::JOB_COA->value is likely 'job_coa' or 2.
            ...
            // Check value of enum.
            // From searching `BudgetingType` previously, I didn't see the file content, but `PrController` uses `\App\Enums\BudgetingType::JOB_COA`.
