<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-2">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('capex.index')">Daftar Capex</x-dropdown-link>
                                @role('Admin')
                                    <div class="border-t border-gray-100"></div>
                                    <div class="px-4 py-2 text-xs text-gray-400 uppercase">Admin</div>
                                    <x-dropdown-link :href="route('admin.capex.assets.index')">Assets (CI)</x-dropdown-link>
                                    <x-dropdown-link :href="route('admin.capex.budgets.index')">Budgets</x-dropdown-link>
                                    <x-dropdown-link :href="route('admin.capex.config.index')">Sign Config</x-dropdown-link>
                                @endrole
                            </x-slot>
                        </x-dropdown>
                    </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('capex.index')">Daftar Capex</x-responsive-nav-link>
            @role('Admin')
                <x-responsive-nav-link :href="route('admin.capex.assets.index')">Capex Assets</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.capex.budgets.index')">Capex Budgets</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.capex.config.index')">Sign Config</x-responsive-nav-link>
            @endrole
