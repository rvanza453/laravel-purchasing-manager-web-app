        ...
        <div class="min-h-screen flex">
            ...
            <aside class="w-64 bg-[#fff8e1] border-r border-gray-200 flex-shrink-0 hidden md:block" style="background-color: #fdfbf7;">
                ...
                <nav class="px-4 space-y-2">
                    ...
                    @role('admin')
                    <x-nav-link :href="route('admin.budget.index')" :active="request()->routeIs('admin.budget.*')" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-white hover:shadow-sm transition-all duration-200">
