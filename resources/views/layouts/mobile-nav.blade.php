<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300 z-[9999] shadow-lg">
    <div class="flex justify-around items-center h-16">
        <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center flex-1 text-gray-600 hover:text-primary-600 {{ request()->routeIs('dashboard') ? 'text-primary-600' : '' }}">
