                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('vendors.update', $vendor) }}" class="space-y-6 max-w-2xl">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <x-input-label for="category" :value="__('Kategori Supplier')" />
                                <x-text-input id="category" class="block mt-1 w-full" type="text" name="category" :value="old('category', $vendor->category ?? '')" />
                                <x-input-error :messages="$errors->get('category')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="location" :value="__('Lokasi')" />
                                <x-text-input id="location" class="block mt-1 w-full" type="text" name="location" :value="old('location', $vendor->location ?? '')" />
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <x-text-input id="pic_name" class="block mt-1 w-full" type="text" name="pic_name" :value="old('pic_name', $vendor->pic_name)" />
                            </div>
                            <div>
                                <x-input-label for="phone" :value="__('No Telpon / HP')" />
