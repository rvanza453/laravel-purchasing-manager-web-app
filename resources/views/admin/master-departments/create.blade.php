<x-admin-layout>
    <div class="max-w-2xl">
        ...
        <form method="POST" action="{{ route('admin.master-departments.store') }}" class="bg-white rounded-lg shadow p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="coa" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('coa') }}" required>
            </div>
