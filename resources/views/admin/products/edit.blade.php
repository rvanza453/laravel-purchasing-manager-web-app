                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-6 max-w-xl">
                        ...
                        <div>
                            ...
                            <x-text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code', $product->code)" required autofocus />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="price_estimation" class="block mt-1 w-full" type="number" name="price_estimation" :value="old('price_estimation', $product->price_estimation)" min="0" step="0.01" />
                        ...
                        <div>
                            ...
                            <x-text-input id="min_stock" class="block mt-1 w-full" type="number" name="min_stock" :value="old('min_stock', $product->min_stock)" min="0" />
