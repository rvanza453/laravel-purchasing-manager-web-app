        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <form action="{{ route('global-approvers.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <x-input-label for="role_name" :value="__('Label Role')" />
                        <x-text-input id="role_name" name="role_name" type="text" class="mt-1 block w-full" placeholder="HO Approver" value="HO Approver" required />
                        <x-input-error class="mt-2" :messages="$errors->get('role_name')" />
                    </div>

                    <div>
                        <x-input-label for="level" :value="__('Urutan Level')" />
                        <x-text-input id="level" name="level" type="number" class="mt-1 block w-full" placeholder="1" required />
                    ...
                    <x-primary-button class="w-full justify-center">{{ __('Tambahkan') }}</x-primary-button>
                </form>
            </div>
