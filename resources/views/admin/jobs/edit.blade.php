        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <form action="{{ route('jobs.update', $job) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code', $job->code)" required />
                    <x-input-error :messages="$errors->get('code')" class="mt-2" />
                </div>
                
                <div class="mb-4">
                    <x-input-label for="department_id" value="Unit / Department (Opsional)" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $job->name)" required />
