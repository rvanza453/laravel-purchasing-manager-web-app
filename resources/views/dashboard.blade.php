<x-app-layout>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <!-- Card 1 -->
            <a href="{{ route('pr.index', ['status' => \App\Enums\PrStatus::PENDING->value]) }}" 
            ...
            <!-- Card 2 -->
             <a href="{{ route('pr.index', ['status' => \App\Enums\PrStatus::APPROVED->value]) }}" 
                ...
                <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Menunggu</span>
                <span class="text-sm font-bold text-blue-600 mb-2 group-hover:text-blue-700">PO Generation</span>
                 <div class="flex items-center gap-3">
            ...
            <!-- Card 3 -->
            <a href="{{ route('pr.index', ['status' => \App\Enums\PrStatus::REJECTED->value]) }}" 
                ...
                <span class="text-sm font-bold text-red-600 mb-2 group-hover:text-red-700">Rejected/Revision</span>
                 <div class="flex items-center gap-3">
            ...
            <!-- Card 4 -->
            <a href="{{ route('pr.index', ['status' => \App\Enums\PrStatus::PO_CREATED->value]) }}" 
                class="bg-white rounded-xl shadow-sm p-6 flex flex-col items-center justify-center border-b-4 border-pink-400 hover:scale-[1.02] transition-all cursor-pointer hover:shadow-md group">
                <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Menunggu</span>
                <span class="text-sm font-bold text-pink-600 mb-2 group-hover:text-pink-700">Barang Datang</span>
                 <div class="flex items-center gap-3">
