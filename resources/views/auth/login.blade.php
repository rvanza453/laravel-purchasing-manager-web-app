<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="relative group">
            ...
            <x-text-input id="email" class="block w-full pl-10 pr-3 py-3 border-gray-200 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-xl transition duration-200 bg-gray-50 hover:bg-white" 
        ...
        <div class="relative group">
            ...
            <x-text-input id="password" class="block w-full pl-10 pr-3 py-3 border-gray-200 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-xl transition duration-200 bg-gray-50 hover:bg-white"
                            type="password"
                            name="password"
